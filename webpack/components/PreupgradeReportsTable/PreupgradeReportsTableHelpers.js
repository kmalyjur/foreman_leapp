...
export const usePreupgradeTableState = (data, isExpanded) => {
  ...
  useEffect(() => {
    ...
    dispatch(
      APIActions.get({
        key: `GET_LEAPP_REPORT_DETAIL_${reportId}_P${pagination.page}_S${searchValue}_O${sortBy.index}${sortBy.direction}`,
        url: `/api/preupgrade_reports/${reportId}`,
        params: {
